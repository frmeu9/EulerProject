...
for lignes in range(20):
    ...
    for colonnes in range(20):
        tempGrid.append(int(grid_str[i:i+2]))
        i += 3
...
for rows in range(20):
    for col in range(17):
        TempProd = 1
        for k in range(num):
            TempProd *= grid[rows][col+k]
        prod.append(TempProd)
